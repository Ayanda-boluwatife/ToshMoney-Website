  ...
  return (
    <Wrapper>
        ...
        <InnerBlog 
             ...
             border1= "Blog post 1"
             list1= 'Bad Bad UI: 10 Common Mistakes in User Interfaces,'
             list2= 'Bad Bad UI: 10 Common Mistakes in User Interfaces,'
             list3= 'Bad Bad UI: 10 Common Mistakes in User Interfaces,'
             list4= 'Bad Bad UI: 10 Common Mistakes in User Interfaces,'
             list5= 'Bad Bad UI: 10 Common Mistakes in User Interfaces,'
             border2= 'Blog post 1'
